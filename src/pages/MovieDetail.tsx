                    ...
                    <div className="flex gap-4 overflow-x-auto scrollbar-hide pb-2 w-full max-w-full min-w-0 touch-pan-x">
                      {cast.map(member => (
                        <div
                          ...
                          className="flex-none w-24 text-center group cursor-pointer touch-feedback"
                          title={`View ${member.name}'s filmography`}
                        >
                          <div className="w-20 h-20 mx-auto rounded-full overflow-hidden border-2 border-white/10 group-hover:border-amber-400 group-hover:scale-105 transition-all bg-neutral-900 shadow-lg">
                            <img
